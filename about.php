...
<section class="white">
    ...
    <div class="inner">
        ...
        <h6>Founded in 1971, Precision Metalwork Inc., specializes in producing metal parts, components, assemblies, and finished products as well as providing a full range of metal fabrication services—including shearing, <a href="/metalwork/punch-form">hole punching</a>, <a href="/metalwork/welding-laser-cutting">laser cutting, welding,</a> bending, <a href="/metalwork/fabrication-assembly">assembling</a>, and <a href="/painting/">painting</a>. </h6>
        ...
        <ul class="twoCol">
            <li><span class="icon-li"></span> Provide our customers with products and services that exceed their expectations.</li>
            <li><span class="icon-li"></span> Foster an atmosphere for continuous improvement by being flexible to new methods, machinery, and education in our trade.</li>
        </ul>

        <ul class="twoCol two">
            <li><span class="icon-li"></span> Cultivate cooperation and mutual respect with our employees and suppliers.</li>
            <li><span class="icon-li"></span> Maintain an attitude of service, while putting our customer's needs first and preeminent.</li>
        </ul>
...
<section class="cta">
    ...
    <div class="inner">
        ...
        <h5><span class="icon-i-welding"></span> Next Up</h5>

        <a class="btn" href="/metalwork/">Metalwork</a>
