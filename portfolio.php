...
<section class="white">
    ...
    <div class="inner">
        ...
        <div class="button-group filters-button-group">
            ...
            <button class="button" data-filter=".punch">Punch</button>
            <button class="button" data-filter=".form">Form</button>
            <button class="button" data-filter=".weld">Weld</button>
            <button class="button" data-filter=".laser">Laser</button>
            <button class="button" data-filter=".grind">Grind</button>
...
<section class="cta">
    ...
    <div class="inner"q>
        ...
        <h5><span class="icon-i-email"></span> Next Up</h5>
